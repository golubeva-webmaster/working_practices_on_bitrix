...
* [Оформление заказа. Подстановка данных физ и юр лиц](https://github.com/golubeva-webmaster/working_practices_on_bitrix/tree/main/js/orderInsertUserInfo)
* [Оформление заказа. Если вес корзины более 5т, отобразить форму для оптовиков](https://github.com/golubeva-webmaster/working_practices_on_bitrix/tree/main/js/optovikFormShow)
...
* [Google search console (ecom tags). Выборка с различных страниц](https://github.com/golubeva-webmaster/working_practices_on_bitrix/tree/main/googleTagManager)
...
* [Битрикс. Техподдержка. Уведомление о снятии ответственности прежниму ответственному](https://github.com/golubeva-webmaster/working_practices_on_bitrix/blob/main/bitrix_support/README.md)
